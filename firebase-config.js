...
const firebaseConfig = {
  ...
  function initializeFirebase() {
    ...
    // Check if essential services loaded, otherwise show a warning
    if (typeof firebase.auth !== 'function' || typeof firebase.firestore !== 'function') {
      if (document.body) {
        showGlobalWarning("This site's functionality is limited. Please disable your ad blocker and refresh the page.");
      }
    }
  ...
  window.AuthService = AuthService; 
    ...
    // Function to show a global warning
    function showGlobalWarning(message) {
        const warningDiv = document.createElement('div');
        warningDiv.style.cssText = 'position: fixed; top: 0; left: 0; right: 0; background-color: #f59e0b; color: white; text-align: center; padding: 10px; z-index: 9999; font-family: sans-serif;';
